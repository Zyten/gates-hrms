...
// })
// //ResetFormConfirm validation
// $(function() {
//     if (!$('#reset-form-confirm').length) {
//         return false;
//     }
...
//         },
//         groups: {
//             pass: "new_password retype_new_password",
//         },
//         errorPlacement: function(error, element) {
//             if (
//                 element.attr("name") == "new_password" || 
//                 element.attr("name") == "retype_new_password" 
//             ) {
//                 error.insertAfter($("#retype_new_password").closest('.row'));
//                 element.parents("div.form-group")
//                 .addClass('has-error');
//             }
//             else {
...
//     $('#reset-form-confirm').validate(loginValidationSettings);
// })
...
$(function () {
	...
	*************************************************/
	...
	function setThemeState() {
		...
		// 	$styleLink.attr('href', APP_URL + '/public/themes/backend/modular_admin/css/app-' + themeSettings.themeName + '.css');
		// }
		// else {
		// 	$styleLink.attr('href', APP_URL + '/public/themes/backend/modular_admin/css/app.css');
		// }
